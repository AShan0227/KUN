...
def _audit_gate(
    *,
    ...
    return GateEvaluation(
        ...
        north_star_verdict="partial" if has_gaps else "pass",
        result_quality=0.76 if has_gaps else 0.94,
        speed=0.78,
        cost=0.86,
        ...
        hard_gate_failures=[gap.gap_id for gap in report.gaps],
        evidence_refs=[artifact.artifact_id],
        artifact_refs=[artifact.artifact_id],
        failure_category="plan_failure" if has_gaps else None,
        ...
        learning_eligibility="candidate" if has_gaps else "none",
...
def _strategy_gate(
    *,
    ...
    return GateEvaluation(
        ...
        responsibility_scope="kun_auto",
        confidence=0.84,
        next_action="promote_candidate" if has_selection else "needs_plan_change",
        next_state="learning_writeback" if has_selection else "changing_plan",
